...
@SwaggerDefinition(tags = {@Tag(name = "消息 API",description = "消息管理的API接口")})
...
//            @ApiImplicitParam(name = "summary",value = "摘要",dataType = "String",paramType = "query")})
    ...
    @ApiOperation(value = "修改消息内容", notes = "根据参数修改消息")
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "id",value = "消息",required = true,dataType = "Long",paramType = "path")})
